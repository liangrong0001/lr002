...
function _processcloudflareHeader() {
  _processcloudflareHeader = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9(cloudflareBuffer, userID) {
    var version, isValidUser, isUDP, slicedBuffer, slicedBufferString, uuids, checkUuidInApi, optLength, command, portIndex, portBuffer, portRemote, addressIndex, addressBuffer, addressType, addressLength, addressValueIndex, addressValue, dataView, ipv6, _i, _t4, _t5, _t6;
    return _regenerator().w(function (_context9) {
      while (1) switch (_context9.n) {
        ...
        case 2:
          ...
          return checkUuidInApiResponse(slicedBufferString);
        case 3:
          _t4.log.call(_t4, _t5.concat.call(_t5, _context9.v, ", userID: ").concat(slicedBufferString));
          if (isValidUser) {
            _context9.n = 4;
            break;
          }
        ...
        case 7:
          ...
          addressValue = "";
          _t6 = addressType;
          _context9.n = _t6 === 1 ? 8 : _t6 === 2 ? 9 : _t6 === 3 ? 10 : 11;
          break;
        case 8:
          addressLength = 4;
          ...
          transformStream.readable.pipeTo(new WritableStream({
            write: function write(chunk) {
              return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee10() {
                var resp, dnsQueryResult, udpSize, udpSizeBuffer, _t8, _t9;
                return _regenerator().w(function (_context10) {
                  while (1) switch (_context10.n) {
                    ...
                    case 3:
                      _t8.send.call(_t8, _context10.v);
                      _context10.n = 6;
                      break;
                    case 4:
                      _t9 = webSocket;
                    ...
                    case 5:
                      _t9.send.call(_t9, _context10.v);
